$(document).ready(function () {
  ...
  var modalText = {
    blog: {
      title: "Pic Blog",
      tag: "nodejs mongodb expressjs passport bootstrap",
      detail:
      ...
      link: "https://blog-app-jatin.herokuapp.com/",
    },
    amazonclone: {
      title: "Amazon Clone",
      tag: "amazon firebase nodejs reactjs",
      detail:
      ...
      link: "https://clone-55ca5.web.app/",
    },
    discover: {
    ...
    walker: {
      ...
      detail:
        "Square.js- Smallest component of React Board.js- Board consist 9 small Squares Game.Js- Game consist logic of the game App.Js- Render Game.js",
    ...
    powur: {
      ...
      tag: "C++ SFML",
      detail:
        "SFML library for graphics and collision detection of asteroid & space ship, bullets & Asteroid is used with c++",
    ...
    never: {
      ...
      detail:
        "A chatApp using Socket.io and expressJS, User Authentication with password and username, Broadcasting to all the users and Private Chat to a username",
